    ...
    >
      <HStack justifyContent="space-around">
        <NextLink href="/" passHref>
          <HStack>
            <Icon as={FaHome} boxSize={48}  color={'#002c8b'}/>
          </HStack>
        </NextLink>
        <NextLink href="/shop" passHref>
          <HStack>
            <Icon as={FaStore} boxSize={48}  color={'#002c8b'}/>
          </HStack>
        </NextLink>
        <NextLink href="/about" passHref>
          <HStack>
            <Icon as={FaInfoCircle} boxSize={48}  color={'#002c8b'}/>
          </HStack>
        </NextLink>
        <NextLink href="/about" passHref>
          <HStack>
...
function Header() {
  return (
    ...
    <Box textAlign="center" p={4} backgroundColor={'#eeeeee'} borderRadius={'16px'} cursor="pointer">
